    ...
    public static void main(String[] args) {
       ...
       // servicio.listarTodos().forEach(System.out::println);
        ...
        static void cu02(){
            ...
            System.out.print("Apellido empieza con (ENTER salta): "); String ap = in.nextLine();
            System.out.print("Nombres empieza con (ENTER salta): "); String no = in.nextLine();
            System.out.print("Tipo doc (DNI/LE/LC/PASAPORTE/OTRO) o ENTER: "); String t = in.nextLine();
            TipoDocumento tipo = t.isBlank()?null:TipoDocumento.valueOf(t.toUpperCase());
            System.out.print("Número doc (ENTER salta): "); String nro = in.nextLine();
